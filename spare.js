        ...
        async function runCompletion(messages) {
            ...
            const completion = await openai.chat.completions.create({
                ...
                functions: [
                    {
                        name: "general_prompt",
                        description: "Answer the general queries according to openai knowledge and greet them",
                        parameters: {
                            type: "object",
                            properties: {
                                input: {
            ...
            if (functionCallName === "general_prompt") {
...
async function general_prompt(input) {
    ...
    //         model: "gpt-3.5-turbo-0613",
    //         messages: {
    //             role: 'system', content: message_command
    //         },
    //         // messages: [{ role: 'user', content: command }],
    //         max_tokens: 200,
